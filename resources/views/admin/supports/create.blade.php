                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <form
                                        action="{{ getAdminPanelUrl() }}/supports/{{ !empty($support) ? $support->id . '/update' : 'store' }}"
                                        method="Post">
                                        {{ csrf_field() }}
                                            ...
                                            <select name="department_id"
                                                ...
                                                @foreach ($departments as $department)
                                                    <option value="{{ $department->id }}"
                                                        @if (!empty($support) and $support->department_id == $department->id) selected @endif>
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-12 col-md-4 mt-2 mt-md-0">
                                                <button
                                                    class="btn btn-primary w-100">{{ trans('admin/main.send') }}</button>
                                            </div>
                                        </div>
