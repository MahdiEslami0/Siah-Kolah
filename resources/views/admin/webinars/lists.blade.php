            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>{{ trans('admin/main.pending_review') }}
                                    {{ trans('admin/main.type_' . $classesType . 's') }}</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <table class="table table-striped font-14 ">
                                    ...
                                    @foreach ($webinars as $webinar)
                                        <tr class="text-center">
                                                ...
                                                @if (!empty($webinar->price) and $webinar->price > 0)
                                                    ...
                                                    @if ($webinar->getDiscountPercent() > 0)
                                                        <div class="text-danger text-small font-600-bold">
                                                            {{ $webinar->getDiscountPercent() }}%
                                                            {{ trans('admin/main.off') }}</div>
                                                    @endif
                                                @else
                                                    {{ trans('public.free') }}
                                                @endif
                                            ...
                                            <td>
                                                ...
                                                @if (!empty($webinar->capacity))
                                                    <div class="text-small font-600-bold">
                                                        ...
                                                        {{ $webinar->getWebinarCapacity() }}</div>
                                                @endif
                                            </td>
                                            ...
                                            <td class="font-12">{{ dateTimeFormat($webinar->created_at, 'Y M j | H:i') }}
                                            </td>
                                                ...
                                                <div class="btn-group dropdown table-actions" style="direction: ltr;">
                                                    ...
                                                    <div class="dropdown-menu text-left webinars-lists-dropdown">
                                                        ...
                                                        @can('admin_webinar_notification_to_students')
                                                            <a href="{{ getAdminPanelUrl() }}/webinars/{{ $webinar->id }}/sendNotification"
                                                                target="_blank"
                                                                class="d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm text-primary mt-1 ">
                                                                <i class="fa fa-bell"></i>
                                                                <span
                                                                    class="ml-2">{{ trans('notification.send_notification') }}</span>
                                                            </a>
                                                        @endcan
                                                        ...
                                                        @can('admin_webinar_statistics')
                                                            <a href="{{ getAdminPanelUrl() }}/webinars/{{ $webinar->id }}/statistics"
                                                                target="_blank"
                                                                class="d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm text-primary mt-1 "
                                                                title="{{ trans('admin/main.students') }}">
