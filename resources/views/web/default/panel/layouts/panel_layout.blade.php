...
<head>
    ...
    <link rel="stylesheet" href="/assets/default/css/app.css?ver={{ filemtime(public_path('/assets/default/css/app.css')) }}">
    <link rel="stylesheet" href="/assets/default/css/panel.css?ver={{ filemtime(public_path('/assets/default/css/panel.css')) }}">
