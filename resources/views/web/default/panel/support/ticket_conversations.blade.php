                                    ...
                                    <select name="department" id="departments" class="form-control">
                                        ...
                                        @foreach ($departments as $department)
                                            <option value="{{ $department->id }}"
                                                @if (request()->get('department') == $department->id) selected @endif>{{ $department->title }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                    ...
                    <div id="conversationsList" class="col-12 col-lg-6 conversations-list">
                        <div class="table-responsive">
                            <table class="table table-md">
                                <tr>
                                    <th class="text-left font-14 text-gray font-weight-500">{{ trans('navbar.title') }}
                                    </th>
                                    <th class="text-center font-14 text-gray font-weight-500">
                                        {{ trans('public.updated_at') }}</th>
                                    <th class="text-center font-14 text-gray font-weight-500">
                                        {{ trans('panel.department') }}</th>
                                    <th class="text-center font-14 text-gray font-weight-500">{{ trans('public.status') }}
                                    </th>
                                </tr>
                                <tbody>
                                            ...
                                            <div class="rounded-sm mt-15 border panel-shadow p-15">
                                                <div
                                                    ...
                                                    <div class="d-flex flex-column align-items-end">
                                                        <span
                                                            class="font-12 text-gray">{{ dateTimeFormat($conversations->created_at, 'j M Y | H:i') }}</span>
